...
def test_05_plugin_getPluginValues(fileSize,fileSizeGB,height,width,
    ...
    pluginDefs = ["VideoMetaData:width", "VideoMetaData:height", "VideoMetaData:duration", "osData:size"]
...
def test_06_plugin_newEntry_wPlugin(mocker):
    ...
    modelDict["Width"] = {"Type" : "Item", "default" : "-1", "hide" : "",
                          "itemType" : "str" ,"plugin" : "VideoMetaData:width"}
    modelDict["Height"] = {"Type" : "Item", "default" : "-1", "hide" : "",
                           "itemType" : "str" ,"plugin" : "VideoMetaData:height"}
